...
public class ArtifactServiceTest {
    ...
    public void setup() throws IOException {
        ...
        Users test_user = new Users(110L, "test user", "password", "test@test.com");

        test_artifact = new Artifact(68L, "test product name", "test Description",
                "some_test_model stored as string", test_user, true);

        ImageFace test_image_face = new ImageFace(99L, "test_front_aspect.png", "test_back_aspect.png",
        ...
        JsonNode expected_artifact_json = mapper.readTree(getClass().getResource("/expected-artifact.json"));
        JsonNode expected_imageface_json = mapper.readTree(getClass().getResource("/expected-image-face.json"));
    ...
    void jsonConsumer() {
        ...
        Assertions.assertNotNull(allArtifacts);
